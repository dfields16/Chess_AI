...
public class Util {
  ...
  public static void loadSquares(Square[][] board) {
    for (int y = 0; y < 8; y++) {
      for (int x = 0; x < 8; x++) {
  ...
  public static void resetPieces(Square[][] board) {
    ...
    public static boolean movePiece(Square[][] board, Move move, int turn) {
      
        if( !validMove(board,move,turn) ) return false;
        ...
        // history.add(new Move(move.start, move.end,
        ...
        //if(board[move.y1()][move.x1()].piece != null)
